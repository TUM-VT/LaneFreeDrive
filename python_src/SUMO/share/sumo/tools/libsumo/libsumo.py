...
class vehicle(_object):
    ...
    if _newclass:
        addR = staticmethod(_libsumo.vehicle_addR)
    else:
        addR = _libsumo.vehicle_addR
    if _newclass:
...
def vehicle_addR(*args, **kwargs):
    return _libsumo.vehicle_addR(*args, **kwargs)
vehicle_addR = _libsumo.vehicle_addR
...
def rerouter_getParameter(rerouterID, param):
    return _libsumo.rerouter_getParameter(rerouterID, param)
...
def rerouter_setParameter(rerouterID, key, value):
    return _libsumo.rerouter_setParameter(rerouterID, key, value)
...
def meandata_getParameter(meanDataID, param):
    return _libsumo.meandata_getParameter(meanDataID, param)
...
def meandata_setParameter(meanDataID, key, value):
    return _libsumo.meandata_setParameter(meanDataID, key, value)
...
def variablespeedsign_getParameter(vssID, param):
    return _libsumo.variablespeedsign_getParameter(vssID, param)
...
def variablespeedsign_setParameter(vssID, key, value):
    return _libsumo.variablespeedsign_setParameter(vssID, key, value)
...
def routeprobe_getParameter(probeID, param):
    return _libsumo.routeprobe_getParameter(probeID, param)
...
def routeprobe_setParameter(probeID, key, value):
    return _libsumo.routeprobe_setParameter(probeID, key, value)
